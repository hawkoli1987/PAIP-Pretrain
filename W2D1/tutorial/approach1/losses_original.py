...
# ---------------------------------------------------------------------------
# ORIGINAL SOURCE (unmodified copy)
# Source: megatron-bridge_yuli/src/megatron/bridge/training/losses.py
#
# This is the standard MegatronBridge loss function.  Notice it returns a
# reporting dict with exactly ONE key: "lm loss".  That key is the only
# metric that flows to W&B from the loss computation.
# ---------------------------------------------------------------------------
